...
<head>
	...
	<title> Read Student Info from Database </title>
</head>
...
<body>
	...
	// Database query.
	$sql = "SELECT * FROM student_api ORDER BY StudentID";
	...
	<div class="container-fuild ml-5 mr-5">
				...
				<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav mr-auto">
							<li class="nav-item">
								<a class="nav-link" href="student_info.php">Students Info<span class="sr-only">(current)</span></a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="student_user.php">Students User</a>
							</li>
						</ul>
					</div>
				</nav>
		...
		<hr>
		<form method="POST" action="input_insert_student_info.php">
		...
		<table class="table table-striped text-center">
			...
			?>
					<tr>
						...
						<td><?= $status ?></td>
						<td>
							<a class="btn btn-info" href="view_student_info.php?stdid=<?= $std_id ?>">View</a>
							<a class="btn btn-warning text-white" href="input_update_student_info.php?stdid=<?= $std_id ?>">Update</a>
							<a class="btn btn-danger" href="delete_student_info.php?stdid=<?= $std_id ?>" onClick="return confirm('Delete this Student?')">Delete</a>
						</td>
					</tr>
